;function SmsApp(phone, success_callback, _options)
{
    ...
    var _create_modal = function(){
            ...
            _tpl += '<input type="number" min=0 max=9999  onchange="handleChange(this);" name="" autocomplete="one-time-code" class="form-control -fs-18 -gil-m js-mask-sms js-sms-code" value="">';
