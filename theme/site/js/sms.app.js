;function SmsApp(phone, success_callback, _options)
{
    ...
    var _create_modal = function(){
            ...
            _tpl += '<input type="number" onkeypress="return isNumberKey(event)" maxlength="4" name="" autocomplete="one-time-code" class="form-control -fs-18 -gil-m js-mask-sms js-sms-code" value="">';
