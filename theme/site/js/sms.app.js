;function SmsApp(phone, success_callback, _options)
{
    ...
    var _create_modal = function(){
            ...
            _tpl += '<input type="number" min=0 max=9999 oninput="validity.valid||(value='');" name="" autocomplete="one-time-code" class="form-control -fs-18 -gil-m js-mask-sms js-sms-code" value="">';
