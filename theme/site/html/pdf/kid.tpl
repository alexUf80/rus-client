...
<table>
    ...
    <tr>
        ...
        <td align="center" rowspan="2">100% страховой премии за вычетом части страховой премии, исчисляемой пропорционально
            времени, в течение которого действовало страхование
        </td>
    </tr>
     <tr>
        <td align="justify">Полное досрочное погашение кредита (займа), для договора заключенного с 01.04.2023 г
        </td>
     </tr>
    <tr>
        <td></td>
    ...
    <tr>
        ...
        <td style="width: 70%">ООО «Микрофинансовая компания …..», 127473, г. Москва, ул.Краснопролетарская, д. 16, стр.1, этаж 1, пом X, комн. 13
        </td>
    </tr>
    <tr>
        <td></td>
