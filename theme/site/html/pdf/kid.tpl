...
<table>
    ...
    <tr>
        <td align="center">подготовлен на основании Правил № 195 комбинированного страхования от несчастных случаев и болезней» САО «ВСК», в редакции, действующей на дату заключения договора страхования.
        </td>
    </tr>
</table>
<div>
            ...
            <table>
                ...
                <tr>
                    <td style="width: 100%;" colspan="2" align="center"><br>По дополнительным страховым рискам выгодоприобретателем
                        является <br> {$firstname|mb_substr:0:1}.{$patronymic|mb_substr:0:1}.{$lastname}.<i>, а в случае его смерти - наследники</i>
                    </td>
                </tr>
            </table>
...
<table border="1">
    ...
    <tr>
        ...
        <td align="justify"  style="50%" rowspan="2">100% страховой премии за вычетом части страховой премии, исчисляемой пропорционально
            времени, в течение которого действовало страхование
        </td>
    </tr>
     <tr>
        <td  style="50%" align="justify">Отказ от договора страхования в связи с полным досрочным погашением кредита (займа)
        </td>
     </tr>
...
<table border="1">
    ...
    <tr>
        ...
        <td style="width: 70%">ООО «Русзаймсервис», 127473, г. Москва, ул.Краснопролетарская, д. 16, стр.1, этаж 1, пом X, комн. 13
        </td>
    </tr>
</table>
<br><br><br>    
