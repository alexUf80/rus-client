...
<div align="justify">
    ...
    № ___ от {$contract->inssuance_date|date} к Договору потребительского займа № {$contract->number}
    от {$contract->inssuance_date|date} (далее - Договор) о нижеследующем:

    <ul>
    <li>Кредитор на условиях, определенных настоящим соглашением предоставляет Заемщику скидку в размере _____________(___________________________)рублей _____ копеек на уплату начисленных процентов по Договору.</li>
