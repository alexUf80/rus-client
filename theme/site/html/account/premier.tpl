        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="pt-4 text-center">
                ...
                {if in_array($order->contract->number, ['НП21-210389'])}
                <div class="pb-3">
                Право требования задолженности по договору {$order->contract->number}
                уступлено "ООО Юридическая компания №1"
                <br />
                тел. 8-800-222-076-69
                </div>
                {/if}
                ...
                <form action="account/pay" method="POST" class="border rounded">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="row">
                                <div class="col-12">
                                    <input type="text" class="form-control text-right" name="amount" value="{$order->contract->loan_body_summ + $order->contract->loan_percents_summ + $order->contract->loan_charge_summ + $order->contract->loan_peni_summ}" />
                                </div>
                            </div>
                        </div>
            ...
            <div class="pt-4 text-center">
                <form action="account/pay" method="POST" class="border rounded">
                    ...
                    <h3 {if $order->prolongation_date} class="mb-0" {/if}>Пролонгация</h3>
