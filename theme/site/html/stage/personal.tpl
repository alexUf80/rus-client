...
<!--div class="error_text">Не верный формат</div-->
                ...
                <div class="form_group -fs-18">
                  ...
                  <div class="form_row">
                    <label class="input_box {if in_array('bad_birth', (array)$errors)}-error{/if}">
                      ...
                      <input type="date" style="padding-left: 20px; padding-top: 20px;" class="form-control  js-input-required"  name="birth" id="birth_date" />
                      <!--<input type="text"  oninput="dateChange(this);"/>-->
                      <!--<span class="input_name {if $birth}-top{/if}">Дата рождения</span>-->
                      <span class="input_name -top">Дата рождения</span>
                ...
                <div class="step_box_btn">
                  ...
                  <a href="/stage/personal?step=prev" class="btn btn_back btn-link -green -gil-m">Назад</a>
